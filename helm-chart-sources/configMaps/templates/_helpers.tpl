...
{{ include "configMaps.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "configMaps.selectorLabels" -}}
...
*/}}
{{- define "configMaps.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "configMaps.fullname" .) .Values.serviceAccount.name }}
{{- else }}
